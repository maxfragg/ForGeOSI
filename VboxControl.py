...
#for i in range(10):
#    time.sleep(4)
#    print v.machines['clone2'].guest.additionsRunLevel
#print 'launch'
#while True:
#    p = v.machines['clone2'].launchProcess('/bin/echo', ['/sbin/ifconfig'])
#    time.sleep(2)
#    #b = v.machines['clone2'].launchProcess('/bin/ps', ['-aux'])
#    time.sleep(4)
#    print 'write'
#    p.write('ifconfig\n')
#    print 'read'
...
#time.sleep(35)
#p = v.launchProcess("Clone", "/bin/ping", ['-c 5', '131.188.31.151'], "default", "12345")
#print "Process launched"
#print "Read"
#time.sleep(5)
#output = p.read(1, 9999999999, 0)
#print "Output %s" % output

#v.machines['clone2'].copyTo('/tmp/rhino.jpg', '/tmp/rhino2.jpg')
#time.sleep(1)
#v.machines['clone2'].copyFrom('/tmp/rhino2.jpg', '/tmp/rhino3.jpg')
#print v.machines['clone2'].stat()
